\begin{tikzpicture}
	...
	% Первый график
	\draw[thick, -latex] (0,0) -- (0,3.1);
	\draw[thick, -latex] (0,0) -- (7.1,0);
	...
	% Второй график
	\draw[thick, -latex] (0,-4) -- (0,-0.90);
	\draw[thick, -latex] (0,-4) -- (7.1,-4);
	...
	% Третий график
	\draw[thick, -latex] (8,0) -- (8,3.1);
	\draw[thick, -latex] (8,0) -- (14.1,0);
	...
	% Четвертый график
	\draw[thick, -latex] (8,-4) -- (8,-0.9);
	\draw[thick, -latex] (8,-4) -- (14.1,-4);
